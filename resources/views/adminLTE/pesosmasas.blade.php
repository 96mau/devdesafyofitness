    ...
    <div class="container-fluid pl-4">
        ...
        <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                <button class="nav-link text-info text-bold" id="nav-profile-tab" data-toggle="tab"
                    data-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile"
                    aria-selected="false">Listar</button>
                <button class="nav-link text-info text-bold active" id="nav-home-tab" data-toggle="tab"
        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane pt-3 fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                {{-- <h3>Crear Nuevo Cliente</h3> --}}
                @livewire('search-clientes')
            </div>
            <div class="tab-pane pt-3 fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                <h3>Crear Nuevo Cliente</h3>
                <div class="card">
                    <div class="card-body">
